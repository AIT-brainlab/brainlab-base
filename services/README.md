...
| :--- | :--- | :--- |
| [**`services/jupyterhub/`**](jupyterhub/README.md) | Multi-user GPU JupyterLab container environment | `https://la.cs.ait.ac.th` |
| [**`services/identity/`**](identity/README.md) | User directory (`lldap`), Google OAuth SSO, and SSSD | `https://ldap.brain.cs.ait.ac.th` |
