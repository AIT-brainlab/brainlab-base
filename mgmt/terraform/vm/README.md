...
flowchart TD
    ...
    subgraph VM ["🖥️ Management VM Engine (brainlab-mgmt-vm)<br/>Ubuntu 24.04 LTS (Asia/Bangkok)"]
        Traefik["🔒 Traefik v3.7 Proxy<br/>(:80, :443)<br/>• Auto Let's Encrypt SSL<br/>• Routes authen2 & netbird2"]
        NBSignal["📡 NetBird Signal v0.77.0<br/>(:33073 UDP/TCP)<br/>• Connection Broker"]
