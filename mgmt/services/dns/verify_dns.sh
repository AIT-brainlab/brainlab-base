#!/usr/bin/env bash
# AIT Brainlab - DNS Resolution & Delegation Check
...
echo -e "\n4. Authoritative GCP Cloud DNS NS Check:"
dig @ns-cloud-a1.googledomains.com "${DOMAIN}" +short || echo "GCP NS pending delegation or propagation."
