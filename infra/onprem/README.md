...
| [**2. Network & Proxy**](network_proxy.md) | CSIM proxy (`192.41.170.23:3128`) & NTP time sync | `/etc/environment`, `/etc/systemd/timesyncd.conf` |
| [**3. NVIDIA GPUs**](nvidia_gpu.md) | CUDA drivers & NVIDIA Container Toolkit runtime | `nvidia-smi`, `/etc/docker/daemon.json` |
| [**4. TrueNAS Storage**](truenas_nfs.md) | Central NFS home directory mount (`/mnt/HDD/home`) | `/etc/fstab` (`cairo:/mnt/HDD/home`) |
